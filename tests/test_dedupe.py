...
def test_dedupe_key_changes_when_link_changes() -> None:
    item1 = FeedItem("Source", "https://example.com/rss", "abc", "Hello", "https://example.com/post1", None, "content", "summary_only")
    item2 = FeedItem("Source", "https://example.com/rss", "abc", "Hello", "https://example.com/post2", None, "content", "summary_only")
